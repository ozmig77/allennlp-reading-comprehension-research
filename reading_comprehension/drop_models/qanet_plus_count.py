...
@Model.register("qanet_plus_count")
class QaNetPlusCount(Model):
    """
    ...
    def forward(self,  # type: ignore
        ...
        best_count_log_prob += answer_type_log_probs[:, 1]
        ...
        if answer_as_passage_spans is not None:
            ...
            log_marginal_likelihood_for_count = \
                answer_type_log_probs[:, 1] + util.logsumexp(log_likelihood_for_counts)
