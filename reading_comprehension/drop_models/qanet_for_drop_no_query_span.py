...
@Model.register("qanet_for_drop_no_query_span")
class QaNetForDropNoQuerySpan(Model):
    """
    ...
    def __init__(self, vocab: Vocabulary,
        ...
        self._span_start_predictor = FeedForward(modeling_out_dim * 2,
                                                 activations=[Activation.by_name('relu')(),
                                                              Activation.by_name('linear')()],
                                                 hidden_dims=[modeling_out_dim, 1],
                                                 num_layers=2)
        self._span_end_predictor = FeedForward(modeling_out_dim * 2,
                                               activations=[Activation.by_name('relu')(),
                                                            Activation.by_name('linear')()],
                                               hidden_dims=[modeling_out_dim, 1],
                                               num_layers=2)
    ...
    def forward(self,  # type: ignore
        ...
        answer_as_spans = answer_as_passage_spans
